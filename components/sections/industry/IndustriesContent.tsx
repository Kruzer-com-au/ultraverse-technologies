        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-4xl mb-20">
            <ScrollReveal>
              ...
              <h2 className="editorial-heading text-[clamp(2rem,5vw,5rem)] text-text-primary mb-6">Technology That Adapts to Your Industry</h2>
            </ScrollReveal>
          </div>
              ...
              <ScrollReveal key={industry.title} delay={idx * 0.06}>
                ...
                >
                  <div className="flex-1">
                    <h3 className="editorial-heading text-[clamp(1.5rem,3.5vw,3.5rem)] text-text-primary group-hover:text-accent-teal-deep transition-colors duration-700">
                      {industry.title}
                    </h3>
