        ...
        <ScrollReveal>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16 md:mb-24">
            <div className="max-w-3xl">
              <p className="editorial-uppercase text-accent-teal text-[10px] font-bold tracking-[0.25em] mb-4 uppercase">
                {label}
              </p>
              <h2 className="editorial-heading text-[clamp(2rem,6vw,4rem)] text-white leading-[0.9] mb-6">
                {title}
              </h2>
              {description && (
            ...
            <div className="hidden lg:block w-24 h-[1px] bg-white/10 mb-6" />
          </div>
        </ScrollReveal>
        ...
        <div className="flex flex-col">
          {members.map((member, idx) => (
            <ScrollReveal key={member.num} delay={idx * 0.05}>
              <div className="group relative py-16 md:py-24 lg:py-28 border-t border-white/10 first:border-t-0 hover:bg-white/[0.01] transition-colors duration-700 px-4 -mx-4">
